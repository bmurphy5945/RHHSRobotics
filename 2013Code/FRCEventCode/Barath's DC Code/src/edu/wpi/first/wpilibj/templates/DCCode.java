 ...
 * directory.
 */
public class DCCode extends IterativeRobot {
    RobotDrive drive;
    ...
    public void autonomousPeriodic() {
       ...
       final double turnAngle =.05;
       final double turnTime = 1;
       final double driveTime2=5;
       ...
       drive.setLeftRightMotorOutputs(driveSpeed+turnAngle,driveSpeed-turnAngle);
       Timer.delay(turnTime);
       drive.setLeftRightMotorOutputs(driveSpeed, driveSpeed);
       Timer.delay(driveTime2);
       drive.setLeftRightMotorOutputs(0,0);
