 ...
 * directory.
 */
public class Drivetrain2 extends IterativeRobot {
    RobotDrive drive;
    ...
    public void teleopPeriodic() {
        ...
        if(leftStick.getTrigger()) {
           System.out.println("Symetrical driving: leftValue is "+leftValue+", rightValue is "+rightValue); 
    ...
    public static double limit(double num) {
        final double limit = .9;//THRESHOLD HIGER 2/12
        if (num > limit) {
            return limit;
        }
        if (num < -limit) {
